...
public class OAuth2WebViewController: NSViewController, WKNavigationDelegate, NSWindowDelegate {
    ...
    private var loadingView: NSView {
        ...
        progressIndicator = NSProgressIndicator(frame: NSRect.zero)
    ...
    override public func loadView() {
        view = NSView(frame: NSRect(x: 0, y: 0, width: OAuth2WebViewController.webViewWindowWidth, height: OAuth2WebViewController.webViewWindowHeight))
        view.translatesAutoresizingMaskIntoConstraints = false
